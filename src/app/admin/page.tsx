...
export default function AdminDashboard() {
  ...
  const paymentModes = data ? [
    { label: 'Cash', amount: data.cashTotal, color: 'bg-emerald-500', light: 'bg-emerald-50 dark:bg-emerald-900/30 text-emerald-700', icon: Banknote },
            ...
            <div className="rounded-2xl bg-white dark:bg-neutral-800 border border-red-100 dark:border-red-800 p-4 shadow-sm">
              ...
              <div className="space-y-2">
                {data.scByStaff.map((staff) => (
                  <div key={staff.name} className="flex items-center gap-3 py-2 px-3 bg-red-50/50 dark:bg-red-900/20 rounded-xl">
                    <div className="flex h-8 w-8 items-center justify-center rounded-full bg-red-100 dark:bg-red-900/40 text-red-700 text-xs font-bold">

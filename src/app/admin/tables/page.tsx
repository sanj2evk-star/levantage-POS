      ...
      {tables.length === 0 ? (
        <Card>
          <CardContent className="py-12 text-center">
            <p className="text-gray-500 dark:text-neutral-400 mb-4">No tables configured yet.</p>
            ...
            <Card key={section.value}>
              ...
              <CardContent>
                {sectionTables.length === 0 ? (
                  <p className="text-gray-400 dark:text-neutral-500 text-sm">No tables in this section</p>
                ) : (

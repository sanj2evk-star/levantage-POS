            ...
            {orders.map(order => {
              ...
              return (
                <button
                  ...
                  className="w-full text-left bg-white rounded-lg p-3 border hover:border-amber-300 hover:bg-amber-50/50 transition-colors"
                >
                  ...
                  <div className="mt-1.5 text-xs text-gray-600 line-clamp-1">

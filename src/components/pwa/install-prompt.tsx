      ...
      <div className="fixed bottom-4 left-4 right-4 z-50 mx-auto max-w-md rounded-xl border border-amber-200 dark:border-amber-800 bg-white dark:bg-neutral-800 p-4 shadow-lg">
        <div className="flex items-center gap-3">
          ...
          <div className="min-w-0 flex-1">
            ...
            <p className="text-xs text-gray-500 dark:text-neutral-400">Add to home screen for quick access</p>
          </div>
          <Button
            size="sm"
          ...
          <button onClick={handleDismiss} className="shrink-0 text-gray-400 dark:text-neutral-500 hover:text-gray-600 dark:hover:text-neutral-300">
            <X className="h-4 w-4" />
          </button>
        </div>
      </div>
